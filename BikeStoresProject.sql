select ord.order_id, CONCAT(cus.first_name,' ', cus.last_name) as customers, cus.city, cus.state, ord.order_date,
	   ...
	   pro.product_name, cat.category_name, br.brand_name, sto.store_name, CONCAT(sta.first_name,' ',sta.last_name) as sales_rep
...
group by ord.order_id, CONCAT(cus.first_name,' ', cus.last_name), cus.city, cus.state, ord.order_date, pro.product_name, 
         cat.category_name, br.brand_name, sto.store_name, CONCAT(sta.first_name,' ',sta.last_name)